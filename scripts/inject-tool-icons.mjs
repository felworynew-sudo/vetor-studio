...
const TOOL_ICONS = {
  ...
  'break-timer': 'taymer', watermark: 'birka', 'svg-cleaner': 'svg',
  ...
  'rule-of-thirds': 'pravilo-tretey', 'icon-scaler': 'masshtab', 'eink-simulator': 'monitor',
  'karma-counter': 'schety', 'background-remover': 'pipidastr', upscaler: 'apskeyl',
  'smart-crop': 'mishen', 'lofi-radio': 'radio', 'audio-enhancer': 'zvukplyus',
  'blur-analyzer': 'glaz', 'audio-trimmer': 'naushniki', 'image-metadata': 'birka',
