...
const READY_COMPONENTS = {
  ...
  multitrack: lazy(() => import('../components/tools/MultitrackEditor')),
  'audio-converter': lazy(() => import('../components/tools/AudioConverter')),
  'raster-editor': lazy(() => import('../components/tools/RasterEditor')),
  'vector-editor': lazy(() => import('../components/tools/VectorEditor')),
